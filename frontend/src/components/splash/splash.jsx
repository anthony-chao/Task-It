      ...
      <div className="splashContainer">
        ...
        <div className="splash-stage">
          ...
          <div className="splash-box">
            ...
            <p>Create projects and tasks. Make your life easier by breaking down your projects into manageable pieces and mark tasks off as you go.</p>
            </div>
          </div>
          <div className="splash-box">
            <div className="splash-in splash-three">
              <h3>Assign Tasks</h3>
              <p>Be proactive. Keep everyone organized by delegating open tasks to yourself and other team members.</p>
            </div>
          </div>
          <div className="splash-box">
            <div className="splash-in splash-four">
              <h3>Live Chat</h3>
              <p>Start chatting. Bring your team together by communicating with your team members through our live chat functionality!</p>
            </div>
          </div>
        </div>
      </div>
